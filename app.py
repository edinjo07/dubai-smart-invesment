...
def send_email(form_data):
    ...
    try:
        ...
        Budget Range: {form_data.get('budgetRange', 'Not specified')}
        Purchase Purpose: {form_data.get('purchasePurpose', 'Not specified')}
...
def save_lead_data(form_data):
    ...
    try:
        ...
        lead_data = {
            ...
            'budgetRange': form_data.get('budgetRange', 'Not specified'),
            'purchasePurpose': form_data.get('purchasePurpose', 'Not specified'),
